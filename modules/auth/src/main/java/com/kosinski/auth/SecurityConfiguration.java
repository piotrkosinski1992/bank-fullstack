...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfiguration(UserPrincipalDetailsService userPrincipalDetailsService, LoadBaseEntity loadBaseEntity) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .addFilter(new JwtAuthorizationFilter(authenticationManager(), this.loadBaseEntity))
                .authorizeRequests()
